...
(function (root, factory) {
  ...
  const toastify = {
    ...
    defaults: {
      ...Toastify.defaults,
      see: "https://github.com/apvarun/toastify-js?tab=readme-ov-file#api",
    },
  };
  ...
  document.addEventListener("DOMContentLoaded", () => {
    injectStylesheet(createToastifyCssText());
  });

  function injectStylesheet(text) {
    const style = document.createElement("style");
    style.textContent = text;
    document.head.appendChild(style);
  }

  function createToastifyCssText() {
    return `
/*!
 *
 * Injected by mintool-crx
 *
 * Toastify js 1.12.0
 * https://github.com/apvarun/toastify-js
 * @license MIT licensed
